...
evaluate(d::CIEDE2000, imgA::AbstractArray{<:Number, 2}, imgB::AbstractArray{<:AbstractGray, 2}) =
    evaluate(d, eltype(imgB).(imgA), imgB)
evaluate(d::CIEDE2000, imgA::AbstractArray{<:AbstractGray, 2}, imgB::AbstractArray{<:Number, 2}) =
